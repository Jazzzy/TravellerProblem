...
public:
    ...
    void generateRandomPopulationButOne(Solution *solution);

    void generateRandomPopulationButTwo(Solution *solution, Solution *solution2);
    ...
    void mergePopulations(Population *population, unsigned int sizelimit);

    unsigned int realSizeOfPopulation();
